...
export const multiplayerSlice = createSlice({
    ...
    reducers: {
        ...
        updatePlaceOnLapMultiplayerAction: (state, action: PayloadAction<{ currentPlace: number, betPlace: number, currentLap: number, betLap: number }>) => {
            ...
            state.placeOnLapMultiplayer = diffMultiplayer(placeDifference, lapDifference);
        },

        updateGapOnLapMultiplayerAction: (state, action: PayloadAction<{ currentGap: number, currentLap: number, betGap: number, betLap: number }>) => {
...
export const {
    ...
    updatePlaceOnLapMultiplayerAction, updateGapOnLapMultiplayerAction
...
export const gapOnLapMultiplayerState = (state: RootState): number => state.multiplayer.gapOnLapMultiplayer;
